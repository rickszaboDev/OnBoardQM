...
namespace BestHTTP
{
    ...
    //using AppCore.ServerManagement;
#endif
    ...
    public sealed class HTTPRequest : IEnumerator, IEnumerator<HTTPRequest>
    {
        ...
        /// <summary>
        /// Used to set the bundle name and manage it's version
        /// </summary>
        //public BundleVersions BundleVersion { get; set; }

        /// <summary>
        /// Used to set the data set name and manage it's version
        /// </summary>
        //public DataSetVersions DataSetVersion { get; set; }
